...
it gets them from the lobbying json, i use ijson as it doesnt load the entire json
into memory, which is important as the lobbying json is like 80mb"""
from flask import request, Response
import json
from mainargs import parsedate, extractdates, searchvalue
import ijson
from config import pagesize, lobbyingg
